...
typedef struct
{
  ...
  __IM  uint32_t ITREAD;
        uint32_t RESERVED4[1U];
  __OM  uint32_t ITWRITE;
        uint32_t RESERVED5[1U];
...
#define ITM_STIM_DISABLED_Msk              (1UL << ITM_STIM_DISABLED_Pos)

#define ITM_STIM_FIFOREADY_Pos              0U
#define ITM_STIM_FIFOREADY_Msk             (1UL)
...
#define TPIU_ACPR_PRESCALER_Msk            (0x1FFFUL)

/** \brief TPIU Selected Pin Protocol Register Definitions */
#define TPIU_SPPR_TXMODE_Pos                0U
#define TPIU_SPPR_TXMODE_Msk               (0x3UL)
...
#define TPIU_FFSR_FlInProg_Msk             (1UL)
...
#define TPIU_PSCR_PSCount_Pos               0U
#define TPIU_PSCR_PSCount_Msk              (0x1FUL)

/** \brief TPIU TRIGGER Register Definitions */
#define TPIU_TRIGGER_TRIGGER_Pos            0U
#define TPIU_TRIGGER_TRIGGER_Msk           (1UL)

/** \brief TPIU Integration Test FIFO Test Data 0 Register Definitions */
#define TPIU_ITFTTD0_ATB_IF2_ATVALID_Pos   29U
#define TPIU_ITFTTD0_ATB_IF2_ATVALID_Msk   (0x3UL << TPIU_ITFTTD0_ATB_IF2_ATVALID_Pos)

#define TPIU_ITFTTD0_ATB_IF2_bytecount_Pos 27U
#define TPIU_ITFTTD0_ATB_IF2_bytecount_Msk (0x3UL << TPIU_ITFTTD0_ATB_IF2_bytecount_Pos)

#define TPIU_ITFTTD0_ATB_IF1_ATVALID_Pos   26U
#define TPIU_ITFTTD0_ATB_IF1_ATVALID_Msk   (0x3UL << TPIU_ITFTTD0_ATB_IF1_ATVALID_Pos)

#define TPIU_ITFTTD0_ATB_IF1_bytecount_Pos 24U
#define TPIU_ITFTTD0_ATB_IF1_bytecount_Msk (0x3UL << TPIU_ITFTTD0_ATB_IF1_bytecount_Pos)

#define TPIU_ITFTTD0_ATB_IF1_data2_Pos     16U
#define TPIU_ITFTTD0_ATB_IF1_data2_Msk     (0xFFUL << TPIU_ITFTTD0_ATB_IF1_data1_Pos)

#define TPIU_ITFTTD0_ATB_IF1_data1_Pos      8U
#define TPIU_ITFTTD0_ATB_IF1_data1_Msk     (0xFFUL << TPIU_ITFTTD0_ATB_IF1_data1_Pos)

#define TPIU_ITFTTD0_ATB_IF1_data0_Pos      0U
#define TPIU_ITFTTD0_ATB_IF1_data0_Msk     (0xFFUL)

/** \brief TPIU Integration Test ATB Control Register 2 Register Definitions */
#define TPIU_ITATBCTR2_AFVALID2S_Pos        1U
#define TPIU_ITATBCTR2_AFVALID2S_Msk       (1UL << TPIU_ITATBCTR2_AFVALID2S_Pos)

#define TPIU_ITATBCTR2_AFVALID1S_Pos        1U
#define TPIU_ITATBCTR2_AFVALID1S_Msk       (1UL << TPIU_ITATBCTR2_AFVALID1S_Pos)

#define TPIU_ITATBCTR2_ATREADY2S_Pos        0U
#define TPIU_ITATBCTR2_ATREADY2S_Msk       (1UL)

#define TPIU_ITATBCTR2_ATREADY1S_Pos        0U
#define TPIU_ITATBCTR2_ATREADY1S_Msk       (1UL)

/** \brief TPIU Integration Test FIFO Test Data 1 Register Definitions */
#define TPIU_ITFTTD1_ATB_IF2_ATVALID_Pos   29U
#define TPIU_ITFTTD1_ATB_IF2_ATVALID_Msk   (0x3UL << TPIU_ITFTTD1_ATB_IF2_ATVALID_Pos)

#define TPIU_ITFTTD1_ATB_IF2_bytecount_Pos 27U
#define TPIU_ITFTTD1_ATB_IF2_bytecount_Msk (0x3UL << TPIU_ITFTTD1_ATB_IF2_bytecount_Pos)

#define TPIU_ITFTTD1_ATB_IF1_ATVALID_Pos   26U
#define TPIU_ITFTTD1_ATB_IF1_ATVALID_Msk   (0x3UL << TPIU_ITFTTD1_ATB_IF1_ATVALID_Pos)

#define TPIU_ITFTTD1_ATB_IF1_bytecount_Pos 24U
#define TPIU_ITFTTD1_ATB_IF1_bytecount_Msk (0x3UL << TPIU_ITFTTD1_ATB_IF1_bytecount_Pos)

#define TPIU_ITFTTD1_ATB_IF2_data2_Pos     16U
#define TPIU_ITFTTD1_ATB_IF2_data2_Msk     (0xFFUL << TPIU_ITFTTD1_ATB_IF2_data1_Pos)

#define TPIU_ITFTTD1_ATB_IF2_data1_Pos      8U
#define TPIU_ITFTTD1_ATB_IF2_data1_Msk     (0xFFUL << TPIU_ITFTTD1_ATB_IF2_data1_Pos)

#define TPIU_ITFTTD1_ATB_IF2_data0_Pos      0U
#define TPIU_ITFTTD1_ATB_IF2_data0_Msk     (0xFFUL)

/** \brief TPIU Integration Test ATB Control Register 0 Definitions */
#define TPIU_ITATBCTR0_AFVALID2S_Pos        1U
#define TPIU_ITATBCTR0_AFVALID2S_Msk       (1UL << TPIU_ITATBCTR0_AFVALID2S_Pos)

#define TPIU_ITATBCTR0_AFVALID1S_Pos        1U
#define TPIU_ITATBCTR0_AFVALID1S_Msk       (1UL << TPIU_ITATBCTR0_AFVALID1S_Pos)

#define TPIU_ITATBCTR0_ATREADY2S_Pos        0U
#define TPIU_ITATBCTR0_ATREADY2S_Msk       (1UL)

#define TPIU_ITATBCTR0_ATREADY1S_Pos        0U
#define TPIU_ITATBCTR0_ATREADY1S_Msk       (1UL)

/** \brief TPIU Integration Mode Control Register Definitions */
#define TPIU_ITCTRL_Mode_Pos                0U
#define TPIU_ITCTRL_Mode_Msk               (0x3UL)

/** \brief TPIU DEVID Register Definitions */
#define TPIU_DEVID_NRZVALID_Pos            11U
#define TPIU_DEVID_NRZVALID_Msk            (1UL << TPIU_DEVID_NRZVALID_Pos)

#define TPIU_DEVID_MANCVALID_Pos           10U
#define TPIU_DEVID_MANCVALID_Msk           (1UL << TPIU_DEVID_MANCVALID_Pos)

#define TPIU_DEVID_PTINVALID_Pos            9U
#define TPIU_DEVID_PTINVALID_Msk           (1UL << TPIU_DEVID_PTINVALID_Pos)

#define TPIU_DEVID_FIFOSZ_Pos               6U
#define TPIU_DEVID_FIFOSZ_Msk              (0x7UL << TPIU_DEVID_FIFOSZ_Pos)

#define TPIU_DEVID_NrTraceInput_Pos         0U
#define TPIU_DEVID_NrTraceInput_Msk        (0x3FUL)

/** \brief TPIU DEVTYPE Register Definitions */
#define TPIU_DEVTYPE_SubType_Pos            4U
#define TPIU_DEVTYPE_SubType_Msk           (0xFUL)

#define TPIU_DEVTYPE_MajorType_Pos          0U
#define TPIU_DEVTYPE_MajorType_Msk         (0xFUL << TPIU_DEVTYPE_MajorType_Pos)
...
#define FPU_MVFR0_FPExceptrap_Msk    (0xFUL << FPU_MVFR0_FPExceptrap_Pos)
...
#define DCB_DHCSR_S_RESTART_ST_Msk         (1UL << DCB_DHCSR_S_RESTART_ST_Pos)

#define DCB_DHCSR_S_RESET_ST_Pos           25U
#define DCB_DHCSR_S_RESET_ST_Msk           (1UL << DCB_DHCSR_S_RESET_ST_Pos)

#define DCB_DHCSR_S_RETIRE_ST_Pos          24U
#define DCB_DHCSR_S_RETIRE_ST_Msk          (1UL << DCB_DHCSR_S_RETIRE_ST_Pos)

#define DCB_DHCSR_S_SDE_Pos                20U
#define DCB_DHCSR_S_SDE_Msk                (1UL << DCB_DHCSR_S_SDE_Pos)

#define DCB_DHCSR_S_LOCKUP_Pos             19U
#define DCB_DHCSR_S_LOCKUP_Msk             (1UL << DCB_DHCSR_S_LOCKUP_Pos)

#define DCB_DHCSR_S_SLEEP_Pos              18U
#define DCB_DHCSR_S_SLEEP_Msk              (1UL << DCB_DHCSR_S_SLEEP_Pos)

#define DCB_DHCSR_S_HALT_Pos               17U
#define DCB_DHCSR_S_HALT_Msk               (1UL << DCB_DHCSR_S_HALT_Pos)

#define DCB_DHCSR_S_REGRDY_Pos             16U
#define DCB_DHCSR_S_REGRDY_Msk             (1UL << DCB_DHCSR_S_REGRDY_Pos)

#define DCB_DHCSR_C_SNAPSTALL_Pos           5U
#define DCB_DHCSR_C_SNAPSTALL_Msk          (1UL << DCB_DHCSR_C_SNAPSTALL_Pos)

#define DCB_DHCSR_C_MASKINTS_Pos            3U
#define DCB_DHCSR_C_MASKINTS_Msk           (1UL << DCB_DHCSR_C_MASKINTS_Pos)

#define DCB_DHCSR_C_STEP_Pos                2U
#define DCB_DHCSR_C_STEP_Msk               (1UL << DCB_DHCSR_C_STEP_Pos)

#define DCB_DHCSR_C_HALT_Pos                1U
#define DCB_DHCSR_C_HALT_Msk               (1UL << DCB_DHCSR_C_HALT_Pos)

#define DCB_DHCSR_C_DEBUGEN_Pos             0U
#define DCB_DHCSR_C_DEBUGEN_Msk            (1UL)

/** \brief DCB Debug Core Register Selector Register Definitions */
#define DCB_DCRSR_REGWnR_Pos               16U
#define DCB_DCRSR_REGWnR_Msk               (1UL << DCB_DCRSR_REGWnR_Pos)
...
#define DCB_DEMCR_TRCENA_Msk               (1UL << DCB_DEMCR_TRCENA_Pos)

#define DCB_DEMCR_MONPRKEY_Pos             23U
#define DCB_DEMCR_MONPRKEY_Msk             (1UL << DCB_DEMCR_MONPRKEY_Pos)

#define DCB_DEMCR_UMON_EN_Pos              21U
#define DCB_DEMCR_UMON_EN_Msk              (1UL << DCB_DEMCR_UMON_EN_Pos)

#define DCB_DEMCR_SDME_Pos                 20U
#define DCB_DEMCR_SDME_Msk                 (1UL << DCB_DEMCR_SDME_Pos)

#define DCB_DEMCR_MON_REQ_Pos              19U
#define DCB_DEMCR_MON_REQ_Msk              (1UL << DCB_DEMCR_MON_REQ_Pos)

#define DCB_DEMCR_MON_STEP_Pos             18U
#define DCB_DEMCR_MON_STEP_Msk             (1UL << DCB_DEMCR_MON_STEP_Pos)

#define DCB_DEMCR_MON_PEND_Pos             17U
#define DCB_DEMCR_MON_PEND_Msk             (1UL << DCB_DEMCR_MON_PEND_Pos)

#define DCB_DEMCR_MON_EN_Pos               16U
#define DCB_DEMCR_MON_EN_Msk               (1UL << DCB_DEMCR_MON_EN_Pos)

#define DCB_DEMCR_VC_SFERR_Pos             11U
#define DCB_DEMCR_VC_SFERR_Msk             (1UL << DCB_DEMCR_VC_SFERR_Pos)

#define DCB_DEMCR_VC_HARDERR_Pos           10U
#define DCB_DEMCR_VC_HARDERR_Msk           (1UL << DCB_DEMCR_VC_HARDERR_Pos)

#define DCB_DEMCR_VC_INTERR_Pos             9U
#define DCB_DEMCR_VC_INTERR_Msk            (1UL << DCB_DEMCR_VC_INTERR_Pos)

#define DCB_DEMCR_VC_BUSERR_Pos             8U
#define DCB_DEMCR_VC_BUSERR_Msk            (1UL << DCB_DEMCR_VC_BUSERR_Pos)

#define DCB_DEMCR_VC_STATERR_Pos            7U
#define DCB_DEMCR_VC_STATERR_Msk           (1UL << DCB_DEMCR_VC_STATERR_Pos)

#define DCB_DEMCR_VC_CHKERR_Pos             6U
#define DCB_DEMCR_VC_CHKERR_Msk            (1UL << DCB_DEMCR_VC_CHKERR_Pos)

#define DCB_DEMCR_VC_NOCPERR_Pos            5U
#define DCB_DEMCR_VC_NOCPERR_Msk           (1UL << DCB_DEMCR_VC_NOCPERR_Pos)

#define DCB_DEMCR_VC_MMERR_Pos              4U
#define DCB_DEMCR_VC_MMERR_Msk             (1UL << DCB_DEMCR_VC_MMERR_Pos)

#define DCB_DEMCR_VC_CORERESET_Pos          0U
#define DCB_DEMCR_VC_CORERESET_Msk         (1UL)

/** \brief DCB Debug Authentication Control Register Definitions */
#define DCB_DAUTHCTRL_INTSPNIDEN_Pos        3U
#define DCB_DAUTHCTRL_INTSPNIDEN_Msk       (1UL << DCB_DAUTHCTRL_INTSPNIDEN_Pos)

#define DCB_DAUTHCTRL_SPNIDENSEL_Pos        2U
#define DCB_DAUTHCTRL_SPNIDENSEL_Msk       (1UL << DCB_DAUTHCTRL_SPNIDENSEL_Pos)

#define DCB_DAUTHCTRL_INTSPIDEN_Pos         1U
#define DCB_DAUTHCTRL_INTSPIDEN_Msk        (1UL << DCB_DAUTHCTRL_INTSPIDEN_Pos)

#define DCB_DAUTHCTRL_SPIDENSEL_Pos         0U
#define DCB_DAUTHCTRL_SPIDENSEL_Msk        (1UL)

/** \brief DCB Debug Security Control and Status Register Definitions */
#define DCB_DSCSR_CDSKEY_Pos               17U
#define DCB_DSCSR_CDSKEY_Msk               (1UL << DCB_DSCSR_CDSKEY_Pos)

#define DCB_DSCSR_CDS_Pos                  16U
#define DCB_DSCSR_CDS_Msk                  (1UL << DCB_DSCSR_CDS_Pos)

#define DCB_DSCSR_SBRSEL_Pos                1U
#define DCB_DSCSR_SBRSEL_Msk               (1UL << DCB_DSCSR_SBRSEL_Pos)

#define DCB_DSCSR_SBRSELEN_Pos              0U
#define DCB_DSCSR_SBRSELEN_Msk             (1UL)
...
#define DIB_DLSR_nTT_Msk                   (1UL << DIB_DLSR_nTT_Pos )

#define DIB_DLSR_SLK_Pos                    1U
#define DIB_DLSR_SLK_Msk                   (1UL << DIB_DLSR_SLK_Pos )

#define DIB_DLSR_SLI_Pos                    0U
#define DIB_DLSR_SLI_Msk                   (1UL)
