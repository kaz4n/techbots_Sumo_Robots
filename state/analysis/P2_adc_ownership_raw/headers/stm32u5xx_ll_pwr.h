...
/** @defgroup PWR_LL_EC_CLEAR_FLAG Clear Flags Defines
  ...
  * @{
  */
#define LL_PWR_SR_CSSF         PWR_SR_CSSF
#define LL_PWR_WUSCR_CWUF1     PWR_WUSCR_CWUF1
#define LL_PWR_WUSCR_CWUF2     PWR_WUSCR_CWUF2
#define LL_PWR_WUSCR_CWUF3     PWR_WUSCR_CWUF3
#define LL_PWR_WUSCR_CWUF4     PWR_WUSCR_CWUF4
#define LL_PWR_WUSCR_CWUF5     PWR_WUSCR_CWUF5
#define LL_PWR_WUSCR_CWUF6     PWR_WUSCR_CWUF6
#define LL_PWR_WUSCR_CWUF7     PWR_WUSCR_CWUF7
#define LL_PWR_WUSCR_CWUF8     PWR_WUSCR_CWUF8
#define LL_PWR_WUSCR_CWUF_ALL  PWR_WUSCR_CWUF
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_GET_FLAG Get Flags Defines
  ...
  * @{
  */
#define LL_PWR_FLAG_VOSRDY      PWR_VOSR_VOSRDY
#define LL_PWR_FLAG_BOOSTRDY    PWR_VOSR_BOOSTRDY
#if defined (PWR_VOSR_USBBOOSTRDY)
#define LL_PWR_FLAG_USBBOOSTRDY PWR_VOSR_USBBOOSTRDY
#endif /* defined (PWR_VOSR_USBBOOSTRDY) */
#define LL_PWR_FLAG_STOPF       PWR_SR_STOPF
#define LL_PWR_FLAG_SBF         PWR_SR_SBF
#define LL_PWR_FLAG_VDDA2RDY    PWR_SVMSR_VDDA2RDY
#define LL_PWR_FLAG_VDDA1RDY    PWR_SVMSR_VDDA1RDY
#define LL_PWR_FLAG_VDDIO2RDY   PWR_SVMSR_VDDIO2RDY
#define LL_PWR_FLAG_VDDUSBRDY   PWR_SVMSR_VDDUSBRDY
#define LL_PWR_FLAG_ACTVOSRDY   PWR_SVMSR_ACTVOSRDY
#define LL_PWR_FLAG_PVDO        PWR_SR2_PVDO
#define LL_PWR_FLAG_REGS        PWR_SVMSR_REGS
#define LL_PWR_FLAG_TEMPH       PWR_BDSR_TEMPH
#define LL_PWR_FLAG_TEMPL       PWR_BDSR_TEMPL
#define LL_PWR_FLAG_VBATH       PWR_BDSR_VBATH

#define LL_PWR_WAKEUP_FLAG1     PWR_WUSR_WUF1
#define LL_PWR_WAKEUP_FLAG2     PWR_WUSR_WUF2
#define LL_PWR_WAKEUP_FLAG3     PWR_WUSR_WUF3
#define LL_PWR_WAKEUP_FLAG4     PWR_WUSR_WUF4
#define LL_PWR_WAKEUP_FLAG5     PWR_WUSR_WUF5
#define LL_PWR_WAKEUP_FLAG6     PWR_WUSR_WUF6
#define LL_PWR_WAKEUP_FLAG7     PWR_WUSR_WUF7
#define LL_PWR_WAKEUP_FLAG8     PWR_WUSR_WUF8
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM2_SB_CONTENTS_RETENTION PWR SRAM2 Content Retention in Standby Mode
  ...
  * @{
  */
#define LL_PWR_SRAM2_SB_NO_RETENTION    0U
#define LL_PWR_SRAM2_SB_PAGE1_RETENTION PWR_CR1_RRSB1
#define LL_PWR_SRAM2_SB_PAGE2_RETENTION PWR_CR1_RRSB2
#define LL_PWR_SRAM2_SB_FULL_RETENTION  (PWR_CR1_RRSB1 | PWR_CR1_RRSB2)
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM1_STOP_CONTENTS_RETENTION PWR SRAM1 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM1_STOP_NO_RETENTION     0U
#define LL_PWR_SRAM1_STOP_PAGE1_RETENTION  (PWR_CR2_SRAM1PDS1)
#define LL_PWR_SRAM1_STOP_PAGE2_RETENTION  (PWR_CR2_SRAM1PDS2)
#define LL_PWR_SRAM1_STOP_PAGE3_RETENTION  (PWR_CR2_SRAM1PDS3)
#if defined (PWR_CR4_SRAM1PDS4)
#define LL_PWR_SRAM1_STOP_PAGE4_RETENTION  (PWR_CR4_SRAM1PDS4)
#define LL_PWR_SRAM1_STOP_PAGE5_RETENTION  (PWR_CR4_SRAM1PDS5)
#define LL_PWR_SRAM1_STOP_PAGE6_RETENTION  (PWR_CR4_SRAM1PDS6)
#define LL_PWR_SRAM1_STOP_PAGE7_RETENTION  (PWR_CR4_SRAM1PDS7)
#define LL_PWR_SRAM1_STOP_PAGE8_RETENTION  (PWR_CR4_SRAM1PDS8)
#define LL_PWR_SRAM1_STOP_PAGE9_RETENTION  (PWR_CR4_SRAM1PDS9)
#define LL_PWR_SRAM1_STOP_PAGE10_RETENTION (PWR_CR4_SRAM1PDS10)
#define LL_PWR_SRAM1_STOP_PAGE11_RETENTION (PWR_CR4_SRAM1PDS11)
#define LL_PWR_SRAM1_STOP_PAGE12_RETENTION (PWR_CR4_SRAM1PDS12)
...
/** @defgroup PWR_LL_EC_SRAM2_STOP_CONTENTS_RETENTION PWR SRAM2 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM2_STOP_NO_RETENTION    0U
#define LL_PWR_SRAM2_STOP_PAGE1_RETENTION (PWR_CR2_SRAM2PDS1)
#define LL_PWR_SRAM2_STOP_PAGE2_RETENTION (PWR_CR2_SRAM2PDS2)
#define LL_PWR_SRAM2_STOP_FULL_RETENTION  (PWR_CR2_SRAM2PDS1 | PWR_CR2_SRAM2PDS2)
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM3_STOP_CONTENTS_RETENTION PWR SRAM3 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM3_STOP_NO_RETENTION     0U
#define LL_PWR_SRAM3_STOP_PAGE1_RETENTION  (PWR_CR2_SRAM3PDS1)
#define LL_PWR_SRAM3_STOP_PAGE2_RETENTION  (PWR_CR2_SRAM3PDS2)
#define LL_PWR_SRAM3_STOP_PAGE3_RETENTION  (PWR_CR2_SRAM3PDS3)
#define LL_PWR_SRAM3_STOP_PAGE4_RETENTION  (PWR_CR2_SRAM3PDS4)
#define LL_PWR_SRAM3_STOP_PAGE5_RETENTION  (PWR_CR2_SRAM3PDS5)
#define LL_PWR_SRAM3_STOP_PAGE6_RETENTION  (PWR_CR2_SRAM3PDS6)
#define LL_PWR_SRAM3_STOP_PAGE7_RETENTION  (PWR_CR2_SRAM3PDS7)
#define LL_PWR_SRAM3_STOP_PAGE8_RETENTION  (PWR_CR2_SRAM3PDS8)
#if defined (PWR_CR4_SRAM3PDS9)
#define LL_PWR_SRAM3_STOP_PAGE9_RETENTION  (PWR_CR4_SRAM3PDS9)
#define LL_PWR_SRAM3_STOP_PAGE10_RETENTION (PWR_CR4_SRAM3PDS10)
#define LL_PWR_SRAM3_STOP_PAGE11_RETENTION (PWR_CR4_SRAM3PDS11)
#define LL_PWR_SRAM3_STOP_PAGE12_RETENTION (PWR_CR4_SRAM3PDS12)
#define LL_PWR_SRAM3_STOP_PAGE13_RETENTION (PWR_CR4_SRAM3PDS13)
...
/** @defgroup PWR_LL_EC_SRAM4_STOP_CONTENTS_RETENTION PWR SRAM4 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM4_STOP_NO_RETENTION    0U
#define LL_PWR_SRAM4_STOP_FULL_RETENTION  PWR_CR2_SRAM4PDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM5_STOP_CONTENTS_RETENTION PWR SRAM5 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM5_STOP_NO_RETENTION     0U
#define LL_PWR_SRAM5_STOP_PAGE1_RETENTION  (PWR_CR4_SRAM5PDS1)
#define LL_PWR_SRAM5_STOP_PAGE2_RETENTION  (PWR_CR4_SRAM5PDS2)
#define LL_PWR_SRAM5_STOP_PAGE3_RETENTION  (PWR_CR4_SRAM5PDS3)
#define LL_PWR_SRAM5_STOP_PAGE4_RETENTION  (PWR_CR4_SRAM5PDS4)
#define LL_PWR_SRAM5_STOP_PAGE5_RETENTION  (PWR_CR4_SRAM5PDS5)
#define LL_PWR_SRAM5_STOP_PAGE6_RETENTION  (PWR_CR4_SRAM5PDS6)
#define LL_PWR_SRAM5_STOP_PAGE7_RETENTION  (PWR_CR4_SRAM5PDS7)
#define LL_PWR_SRAM5_STOP_PAGE8_RETENTION  (PWR_CR4_SRAM5PDS8)
#define LL_PWR_SRAM5_STOP_PAGE9_RETENTION  (PWR_CR4_SRAM5PDS9)
#define LL_PWR_SRAM5_STOP_PAGE10_RETENTION (PWR_CR4_SRAM5PDS10)
#define LL_PWR_SRAM5_STOP_PAGE11_RETENTION (PWR_CR4_SRAM5PDS11)
#define LL_PWR_SRAM5_STOP_PAGE12_RETENTION (PWR_CR4_SRAM5PDS12)
#define LL_PWR_SRAM5_STOP_PAGE13_RETENTION (PWR_CR4_SRAM5PDS13)
...
/** @defgroup PWR_LL_EC_SRAM6_STOP_CONTENTS_RETENTION PWR SRAM6 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_SRAM6_STOP_NO_RETENTION     0U
#define LL_PWR_SRAM6_STOP_PAGE1_RETENTION  (PWR_CR5_SRAM6PDS1)
#define LL_PWR_SRAM6_STOP_PAGE2_RETENTION  (PWR_CR5_SRAM6PDS2)
#define LL_PWR_SRAM6_STOP_PAGE3_RETENTION  (PWR_CR5_SRAM6PDS3)
#define LL_PWR_SRAM6_STOP_PAGE4_RETENTION  (PWR_CR5_SRAM6PDS4)
#define LL_PWR_SRAM6_STOP_PAGE5_RETENTION  (PWR_CR5_SRAM6PDS5)
#define LL_PWR_SRAM6_STOP_PAGE6_RETENTION  (PWR_CR5_SRAM6PDS6)
#define LL_PWR_SRAM6_STOP_PAGE7_RETENTION  (PWR_CR5_SRAM6PDS7)
#define LL_PWR_SRAM6_STOP_PAGE8_RETENTION  (PWR_CR5_SRAM6PDS8)
...
/** @defgroup PWR_LL_EC_ICACHERAM_STOP_CONTENTS_RETENTION PWR ICACHE Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_ICACHERAM_STOP_NO_RETENTION    0U
#define LL_PWR_ICACHERAM_STOP_FULL_RETENTION  PWR_CR2_ICRAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_DCACHE1RAM_STOP_CONTENTS_RETENTION PWR DCACHE1 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_DCACHE1RAM_STOP_NO_RETENTION   0U
#define LL_PWR_DCACHE1RAM_STOP_FULL_RETENTION PWR_CR2_DC1RAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_DCACHE2RAM_STOP_CONTENTS_RETENTION PWR DCACHE2 Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_DCACHE2RAM_STOP_NO_RETENTION   0U
#define LL_PWR_DCACHE2RAM_STOP_FULL_RETENTION PWR_CR2_DC2RAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_DMA2DRAM_STOP_CONTENTS_RETENTION PWR DMA2DRAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_DMA2DRAM_STOP_NO_RETENTION    0U
#define LL_PWR_DMA2DRAM_STOP_FULL_RETENTION  PWR_CR2_DMA2DRAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_PERIPHRAM_STOP_CONTENTS_RETENTION PWR PERIPHRAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_PERIPHRAM_STOP_NO_RETENTION    0U
#define LL_PWR_PERIPHRAM_STOP_FULL_RETENTION  PWR_CR2_PRAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_PKARAM_STOP_CONTENTS_RETENTION PWR PKARAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_PKARAM_STOP_NO_RETENTION    0U
#define LL_PWR_PKARAM_STOP_FULL_RETENTION  PWR_CR2_PKARAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_GPRAM_STOP_CONTENTS_RETENTION PWR GPRAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_GRAPHICPERIPHRAM_STOP_NO_RETENTION   0U
#define LL_PWR_GRAPHICPERIPHRAM_STOP_FULL_RETENTION PWR_CR2_GPRAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_DSIRAM_STOP_CONTENTS_RETENTION PWR DSI RAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_DSIRAM_STOP_NO_RETENTION   0U
#define LL_PWR_DSIRAM_STOP_FULL_RETENTION PWR_CR2_DSIRAMPDS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_JPEGRAM_STOP_CONTENTS_RETENTION PWR JPEG RAM Content Retention in Stop Mode
  * @{
  */
#define LL_PWR_JPEGRAM_STOP_NO_RETENTION   0U
#define LL_PWR_JPEGRAM_STOP_FULL_RETENTION PWR_CR2_JPEGRAMPDS
/**
  * @}
  */
#endif /* defined (PWR_CR2_JPEGRAMPDS) */
...
/** @defgroup PWR_LL_EC_SRAM1_RUN_CONTENTS_RETENTION PWR SRAM1 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM1_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM1_RUN_FULL_RETENTION PWR_CR1_SRAM1PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM2_RUN_CONTENTS_RETENTION PWR SRAM2 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM2_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM2_RUN_FULL_RETENTION PWR_CR1_SRAM2PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM3_RUN_CONTENTS_RETENTION PWR SRAM3 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM3_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM3_RUN_FULL_RETENTION PWR_CR1_SRAM3PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM4_RUN_CONTENTS_RETENTION PWR SRAM4 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM4_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM4_RUN_FULL_RETENTION PWR_CR1_SRAM4PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM5_RUN_CONTENTS_RETENTION PWR SRAM5 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM5_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM5_RUN_FULL_RETENTION PWR_CR1_SRAM5PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRAM6_RUN_CONTENTS_RETENTION PWR SRAM6 Content Retention in Run Mode
  * @{
  */
#define LL_PWR_SRAM6_RUN_NO_RETENTION   0U
#define LL_PWR_SRAM6_RUN_FULL_RETENTION PWR_CR1_SRAM6PD
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_SRD_MODE PWR Smart Run Domain Mode
  * @{
  */
#define LL_PWR_SRD_STOP_MODE  0U
#define LL_PWR_SRD_RUN_MODE   PWR_CR2_SRDRUN
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_REGULATOR_SUPPLY_SELECTION PWR Regulator Supply Selection
  * @{
  */
#define LL_PWR_LDO_SUPPLY   0U
#define LL_PWR_SMPS_SUPPLY  PWR_CR3_REGSEL
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_VOLTAGE_SCALING_RANGE_SELECTION PWR Voltage scaling range selection
  * @{
  */
#define LL_PWR_REGU_VOLTAGE_SCALE1 PWR_VOSR_VOS
#define LL_PWR_REGU_VOLTAGE_SCALE2 PWR_VOSR_VOS_1
#define LL_PWR_REGU_VOLTAGE_SCALE3 PWR_VOSR_VOS_0
#define LL_PWR_REGU_VOLTAGE_SCALE4 0x00000000U
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_PVD_LEVEL_SELECTION PWR Power Voltage Detector Level Selection
  * @{
  */
#define LL_PWR_PVDLEVEL_0 0U
#define LL_PWR_PVDLEVEL_1 PWR_SVMCR_PVDLS_0
#define LL_PWR_PVDLEVEL_2 PWR_SVMCR_PVDLS_1
#define LL_PWR_PVDLEVEL_3 (PWR_SVMCR_PVDLS_0 | PWR_SVMCR_PVDLS_1)
#define LL_PWR_PVDLEVEL_4 PWR_SVMCR_PVDLS_2
#define LL_PWR_PVDLEVEL_5 (PWR_SVMCR_PVDLS_0 | PWR_SVMCR_PVDLS_2)
#define LL_PWR_PVDLEVEL_6 (PWR_SVMCR_PVDLS_1 | PWR_SVMCR_PVDLS_2)
...
/** @defgroup PWR_LL_EC_WAKEUP_PIN PWR Wake Up Pin
  * @{
  */
#define LL_PWR_WAKEUP_PIN1 PWR_WUCR1_WUPEN1
#define LL_PWR_WAKEUP_PIN2 PWR_WUCR1_WUPEN2
#define LL_PWR_WAKEUP_PIN3 PWR_WUCR1_WUPEN3
#define LL_PWR_WAKEUP_PIN4 PWR_WUCR1_WUPEN4
#define LL_PWR_WAKEUP_PIN5 PWR_WUCR1_WUPEN5
#define LL_PWR_WAKEUP_PIN6 PWR_WUCR1_WUPEN6
#define LL_PWR_WAKEUP_PIN7 PWR_WUCR1_WUPEN7
#define LL_PWR_WAKEUP_PIN8 PWR_WUCR1_WUPEN8
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_WAKEUP_PIN_SELECTION PWR Wakeup Pin Selection
  * @{
  */
#define LL_PWR_WAKEUP_PIN_SELECTION_0 0UL
#define LL_PWR_WAKEUP_PIN_SELECTION_1 PWR_WUCR3_WUSEL1_0
#define LL_PWR_WAKEUP_PIN_SELECTION_2 PWR_WUCR3_WUSEL1_1
#define LL_PWR_WAKEUP_PIN_SELECTION_3 PWR_WUCR3_WUSEL1
/**
  * @}
  */
...
#define LL_PWR_BATT_CHARG_RESISTOR_1_5K PWR_BDCR2_VBRS
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_GPIO_PORT_SELECTION PWR GPIO Port Selection
  * @{
  */
#define LL_PWR_GPIO_PORTA (&(PWR->PUCRA))
#define LL_PWR_GPIO_PORTB (&(PWR->PUCRB))
#define LL_PWR_GPIO_PORTC (&(PWR->PUCRC))
#define LL_PWR_GPIO_PORTD (&(PWR->PUCRD))
#define LL_PWR_GPIO_PORTE (&(PWR->PUCRE))
#ifdef PWR_PUCRF_PU0
#define LL_PWR_GPIO_PORTF (&(PWR->PUCRF))
#endif /* PWR_PUCRF_PU0 */
#define LL_PWR_GPIO_PORTG (&(PWR->PUCRG))
#define LL_PWR_GPIO_PORTH (&(PWR->PUCRH))
#ifdef PWR_PUCRI_PU0
#define LL_PWR_GPIO_PORTI (&(PWR->PUCRI))
#endif /* PWR_PUCRI_PU0 */
#if defined (PWR_PUCRJ_PU0)
#define LL_PWR_GPIO_PORTJ (&(PWR->PUCRJ))
...
/** @defgroup PWR_LL_EC_GPIO_PIN_MASK PWR GPIO Pin Mask
  * @{
  */
#define LL_PWR_GPIO_PIN_0  (0x0001U)
#define LL_PWR_GPIO_PIN_1  (0x0002U)
#define LL_PWR_GPIO_PIN_2  (0x0004U)
#define LL_PWR_GPIO_PIN_3  (0x0008U)
#define LL_PWR_GPIO_PIN_4  (0x0010U)
#define LL_PWR_GPIO_PIN_5  (0x0020U)
#define LL_PWR_GPIO_PIN_6  (0x0040U)
#define LL_PWR_GPIO_PIN_7  (0x0080U)
#define LL_PWR_GPIO_PIN_8  (0x0100U)
#define LL_PWR_GPIO_PIN_9  (0x0200U)
#define LL_PWR_GPIO_PIN_10 (0x0400U)
#define LL_PWR_GPIO_PIN_11 (0x0800U)
#define LL_PWR_GPIO_PIN_12 (0x1000U)
#define LL_PWR_GPIO_PIN_13 (0x2000U)
#define LL_PWR_GPIO_PIN_14 (0x4000U)
#define LL_PWR_GPIO_PIN_15 (0x8000U)
/**
  * @}
  */
...
/** @defgroup PWR_LL_EC_ITEMS_SECURE_ATTRIBUTE PWR Items Secure Attribute
  * @{
  */
#define LL_PWR_WAKEUP_PIN1_NSEC 0U
#define LL_PWR_WAKEUP_PIN1_SEC  PWR_SECCFGR_WUP1SEC
#define LL_PWR_WAKEUP_PIN2_NSEC 0U
#define LL_PWR_WAKEUP_PIN2_SEC  PWR_SECCFGR_WUP2SEC
#define LL_PWR_WAKEUP_PIN3_NSEC 0U
#define LL_PWR_WAKEUP_PIN3_SEC  PWR_SECCFGR_WUP3SEC
#define LL_PWR_WAKEUP_PIN4_NSEC 0U
#define LL_PWR_WAKEUP_PIN4_SEC  PWR_SECCFGR_WUP4SEC
#define LL_PWR_WAKEUP_PIN5_NSEC 0U
#define LL_PWR_WAKEUP_PIN5_SEC  PWR_SECCFGR_WUP5SEC
#define LL_PWR_WAKEUP_PIN6_NSEC 0U
#define LL_PWR_WAKEUP_PIN6_SEC  PWR_SECCFGR_WUP6SEC
#define LL_PWR_WAKEUP_PIN7_NSEC 0U
#define LL_PWR_WAKEUP_PIN7_SEC  PWR_SECCFGR_WUP7SEC
#define LL_PWR_WAKEUP_PIN8_NSEC 0U
#define LL_PWR_WAKEUP_PIN8_SEC  PWR_SECCFGR_WUP8SEC

#define LL_PWR_LPM_NSEC 0U
#define LL_PWR_LPM_SEC  PWR_SECCFGR_LPMSEC
#define LL_PWR_VDM_NSEC 0U
#define LL_PWR_VDM_SEC  PWR_SECCFGR_VDMSEC
#define LL_PWR_VB_NSEC  0U
#define LL_PWR_VB_SEC   PWR_SECCFGR_VBSEC
#define LL_PWR_APC_NSEC 0U
